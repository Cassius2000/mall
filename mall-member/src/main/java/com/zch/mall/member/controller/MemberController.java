package com.zch.mall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.zch.mall.member.feign.CouponFeignService;
...
import com.zch.mall.member.service.MemberService;
...
public class MemberController {
    ...
    public R test(){
        ...
        R couponMember = couponFeignService.couponMembers();
